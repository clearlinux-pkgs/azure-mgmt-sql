...
Source0  : https://files.pythonhosted.org/packages/c4/1f/40af724de7a0b00f9a8986ec3554adf1c1cbc5f65c6401d3b0d7b86fc169/azure-mgmt-sql-1.0.0.zip
Summary  : Microsoft Azure SQL Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-sql-python = %{version}-%{release}
Requires: azure-mgmt-sql-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-sql package.
Group: Default
Requires: azure-mgmt-sql-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-sql package.


%package python3
Summary: python3 components for the azure-mgmt-sql package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_sql)
Requires: pypi(azure_common)
Requires: pypi(azure_mgmt_core)
Requires: pypi(msrest)

%description python3
python3 components for the azure-mgmt-sql package.


%prep
%setup -q -n azure-mgmt-sql-1.0.0
cd %{_builddir}/azure-mgmt-sql-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608047974
